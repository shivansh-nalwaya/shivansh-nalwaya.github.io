...
Main.customAnimation = (t) => {
  ray.set(new Vector3(Main.position.x + 3, 100, Main.position.z + 3), new Vector3(0, -1, 0));
  ray2.set(new Vector3(Main.position.x - 3, 100, Main.position.z + 3), new Vector3(0, -1, 0));
  ray3.set(new Vector3(Main.position.x + 3, 100, Main.position.z - 3), new Vector3(0, -1, 0));
  ray4.set(new Vector3(Main.position.x - 3, 100, Main.position.z - 3), new Vector3(0, -1, 0));
  ...
  if (intersect.length > 0) {
    ...
    // intersect[0].object.material.emissive.setHex(0x787878);
    if (Math.abs(Main.position.y - y) < 10) Main.position.setY(y);
    else {
      // walkSpeed = 0.2;
